                                    ...
                                    for rs in [256, 512, 1024, 2048, 4096, 8192]:
                                        for k in [0.03, 0.05, 0.1]:
                                            ...
                                            if (lr, rlr, s, rs, l, k) in \
                                                [
                                                    (1e-4, 1e-4, 2048, 256, 0.3, 0.05),
                                                    # (1e-4, 1e-3, 2048, 1024, 0.01, 0.1),

                                                    # (1e-4, 1e-3, 1024, 512, 0.1, 0.05),
                                                    # (1e-4, 1e-3, 1024, 512, 0.1, 0.1),
                                                    # (1e-4, 1e-3, 1024, 512, 0.3, 0.05),
                                                    # (1e-4, 1e-4, 1024, 512, 0.01, 0.05),
                                                    # (1e-4, 1e-4, 1024, 512, 0.1, 0.05),
                                                    # (1e-4, 1e-4, 1024, 512, 0.1, 0.01),
                                                    # (1e-4, 1e-4, 1024, 512, 0.3, 0.05),
                                                    # (1e-4, 1e-3, 1024, 1024, 0.1, 0.03),
                                                    # (1e-4, 1e-3, 1024, 1024, 0.1, 0.05),
