                                    ...
                                    for rs in [256, 512, 1024, 2048, 4096, 8192]:
                                        for k in [0.03, 0.05, 0.1]:
                                            ...
                                            if (lr, rlr, s, rs, l, k) in \
                                                [
                                                    (1e-3, 1e-3, 4096, 512, 0.3, 0.05),
                                                    # (1e-3, 1e-5, 2048, 2048, 0.01, 0.03),
                                                    # (1e-3, 1e-5, 2048, 2048, 0.01, 0.05),
                                                    # (1e-3, 1e-5, 4096, 2048, 0.01, 0.05),
                                                    # (1e-3, 1e-5, 4096, 2048, 0.01, 0.1),
