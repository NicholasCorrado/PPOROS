...
for b in [1]:
    for i in range(3):
        ...
        os.system(f'python ../ppo_props_discrete.py -f results2 -s b_{b}'
                  f' --env-id GridWorld-v0 --total-timesteps 10000 --eval-freq 1 --eval-episodes 100'
                  f'  -b {b}  --num-steps 500 -lr 0.01 --update-epochs 1 --num-minibatches 1 '
                  f' --props 1 --props-target-kl 1 --props-clip-coef 0.3 --props-lambda 0 --props-num-steps 25 --props-update-epochs 16 -props-lr 0.005 --props-num-minibatches 1'
                  f' --se 0 --se-freq 1 ')
