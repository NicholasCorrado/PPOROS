...
if __name__ == "__main__":
    ...
    for env_id in env_ids:
        ...
        path_dict_all = {}
        ### PROPS ##################################################################################################
        key = rf'Adaptive Sampling (PROPS)'
        algo = 'ppo_props'
        ...
        # fig.subplots_adjust(top=0.8)
        ax.legend(loc='lower right', ncols=1, fontsize=20)
        ...
        fig.subplots_adjust(top=0.8)
        fig.legend(loc='upper center', ncols=3, fontsize=20)
