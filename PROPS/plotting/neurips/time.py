...
if __name__ == "__main__":
    ...
    env_ids = ['Swimmer-v4', 'Hopper-v4', 'HalfCheetah-v4', 'Walker2d-v4', 'Ant-v4']
    # env_ids = ['Ant-v4']
    ...
    for env_id in env_ids:
        ...
        for k, v in return_dict.items():
            ...
            # timestep_dict[k] = x_scale[env_id][k]/x_scale[env_id]['T'] * timestep_dict[k]
        ...
        iqm_scores, iqm_cis = rly.get_interval_estimates(
            ale_frames_scores_dict, iqm, reps=200)
    ...
    #
    save_dir = f'figures'
    save_name = f'return_iqm_sac.png'
